...
for i in range(0,14):
	maeRidge.append(ridgeData[i][1])
	mseRidge.append(ridgeData[i][2])
	maeGradient.append(gradientData[i][1])
	mseGradient.append(gradientData[i][2])
	maeMLP.append(mlpData[i][1])
	mseMLP.append(mlpData[i][2])
	maeLinear.append(linearData[i][1])
	mseLinear.append(linearData[i][2])
