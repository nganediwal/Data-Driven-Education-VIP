...
## Team Meeting(30th Sep):
  ...
  - MSA Applicant Success Prediction Project
    ...
    - The applicants’ GPA played the most important role for being admitted to the program.foloowed by the duration that the applicant spent in a college.
    - The projetc made progress in data processing and succeeded model training & performance testing with reasonably high accuracy
    - Future Work
      - Model the successful completion of the OMSA program
  ...
  - Analyzing MOOC Environment Using Clickstream Data
    ...
    - How is learners’ interaction with the MOOC coursewarerelated to their course engagement?
    - Data Findings:
  ...
  - Discussed the potential use of similar research items in the JITI Data modelling team.

## TODO Tasks:
  - Explore feature importance further
  - Analyze the data further to some up with trends in the data. Represent them in plots.
...
## Sub-team meeting(29th Sep):'
  ...
  - Showed the team plots for the correlations of variables
